...
import { Calendar, MapPin, Phone, User, ShoppingBag, CheckCircle, AlertTriangle } from "lucide-react"
...
const mockBranches: Branch[] = [
  ...
  },
  {
    id: "3",
    name: "West End Store",
    address: "789 West Blvd, West End, ST 12347",
    phone: "(555) 345-6789",
...
export const CheckoutForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchBranches = async () => {
      try {
        // In a real app: const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/branches`)
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.branchId) {
      newErrors.branchId = "Please select a pickup location"
    }
        ...
        <Card className="bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              <p className="text-lg mb-2">Your reservation has been successfully submitted.</p>
              <div className="bg-muted rounded-lg p-4">
                <p className="font-semibold">Reservation ID:</p>
                <p className="text-2xl font-mono text-primary">{reservationId}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Pickup Date: {new Date(formData.pickupDate).toLocaleDateString()}</span>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  <p className="font-semibold text-yellow-800 mb-2">Important Reminders:</p>
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Complete your order for pickup at one of our locations.</p>
      </div>
            ...
            <Card className="bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm">
                        ...
                        <p className="text-muted-foreground">{selectedBranch.phone}</p>
                        <p className="text-muted-foreground">{selectedBranch.hours}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div>
                  ...
                  />
                  {errors.pickupDate && <p className="text-sm text-destructive mt-1">{errors.pickupDate}</p>}
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-muted/50 rounded-lg p-4 border-l-4 border-primary">
                  ...
                  <p className="text-xs text-muted-foreground">
                    All orders are for pickup only. Payment due at pickup with valid ID and background check completion.
                  </p>
                </div>
              </CardContent>
            </Card>
